...
typedef struct binary_trees bst_t;
typedef struct binary_trees avl_t;
typedef struct binary_trees heap_t;
...
binary_tree_t *find_root_node(const binary_tree_t *tree);
